...
//            "Assets/Game"
        ...
        /// 查找对象所有依赖，和对它的引用
        /// </summary>
        [MenuItem("Veewo/Find Object Dependencies", false, 1001)]
        public static void FindObjectDependencies()
        {
            ...
            foreach (string name in names)
            {
                ...
                canceled = ShowProgress((float) i / (float) names.Length, names.Length, i);
                i++;
            }
            ...
            foreach (string guid in allGuids)
            {
                ...
                canceled = ShowProgress((float) i / (float) allGuids.Length, allGuids.Length, i);
                i++;
            }
            ...
            var titleMsg = "Object Dependencies";
            titleMsg += canceled ? "(canceled)" : "";
            EditorWindow.GetWindow<FindReference>(false, titleMsg, true).Show();
