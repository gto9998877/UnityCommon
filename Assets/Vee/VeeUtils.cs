...
// using Games.Data.Config;
using Object = UnityEngine.Object;

namespace Vee
{

    public static class VeeUtils
    {
...
//#endif
        ...
        /// <typeparam name="T"></typeparam>
        public static void LogObj<T> (T obj, string tag = "") {
            var json = JsonUtils.toJson (obj);
            
            Debug.Log($"{tag} {json}");
        }

        public static void LogDictionary<T, U> (Dictionary<T, U> dic) {

            var keyJson = JsonUtils.toJson (new List<T> (dic.Keys));
            Debug.Log("keys : " + keyJson);
            var valueJson = JsonUtils.toJson (new List<U> (dic.Values));
            Debug.Log("values : " + valueJson);
        }
        ...
        /// <summary>
        /// vector2 转为 Coordinate
        /// </summary>
        /// <returns>The coordinate.</returns>
        /// <param name="vec">Vec.</param>
        public static Coordinate ToCoordinate(this Vector2 vec)
        {
            return new Coordinate((int)vec.x, (int)vec.y);
        }
        /// <summary>
        /// Coordinate 转为 vector2
        /// </summary>
        /// <returns>The vector2.</returns>
        /// <param name="coo">Coo.</param>
        public static Vector2 ToVector2(this Coordinate coo)
        {
            return new Vector2((float)coo.x, (float)coo.y);
        }
        #endregion // 类型转换
        ...
        public static Vector2 RandomPosCircle(Vector2 center, float radius) {
            return MathUtils.FloatIsZero(radius) ? center : MathUtils.GetPointWithAngle(center, RandomInt(0, 100) / 100f * radius, RandomInt(0, 360));
        }
